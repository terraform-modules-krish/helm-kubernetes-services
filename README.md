...
* [charts](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/charts): This folder contains the main implementation code for this Package, broken down into multiple
  standalone charts.
* [examples](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/examples): This folder contains examples of how to use the Charts.
* [test](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/test): Automated tests for the Charts and examples.

The following charts are available in this package:

- [k8s-service](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/charts/k8s-service): Deploy a set of Docker containers as a
...
<!-- NOT YET IMPLEMENTED
- [k8s-daemon-set](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/charts/k8s-daemon-set): Deploy a set of Docker containers as a
  [Kubernetes DaemonSet](https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/),
  which provisions a Pod with a
  [Controller](https://kubernetes.io/docs/concepts/workloads/pods/pod-overview/#pods-and-controllers)
  that will automatically schedule one instance of the Pod on every Node available.
- [k8s-job](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/charts/k8s-job): Deploy a set of Docker containers as a
...
- Jobs, which are Pods with a controller that will guarantee the Pods run to completion. See the [k8s-job
  chart](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/charts/k8s-job) for more information.
- Deployments behind a Service, which are Pods with a controller that implement lifecycle rules to provide replication
  ...
  the [k8s-service chart](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/charts/k8s-service) for more information.
- Daemon Sets, which are Pods that are scheduled on all worker nodes. Daemon Sets schedule exactly one instance of a Pod
  ...
  new nodes that join the cluster. See the [k8s-daemon-set chart](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/charts/k8s-daemon-set) for more information.
...
Contributions are very welcome! Check out the [Contribution Guidelines](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/CONTRIBUTING.md) for instructions.
...
Please see [LICENSE](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/LICENSE) and [NOTICE](https://github.com/terraform-modules-krish/helm-kubernetes-services/blob/v0.0.9/NOTICE) for how the code in this repo is licensed.
