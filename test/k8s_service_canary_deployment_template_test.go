...
// Test that setting canary.enabled = false will cause the helm template to not render the canary Deployment resource
func TestK8SServiceCanaryEnabledFalseDoesNotCreateCanaryDeployment(t *testing.T) {
	t.Parallel()
...
func TestK8SServiceCanaryEnabledCreatesCanaryDeployment(t *testing.T) {
	t.Parallel()
